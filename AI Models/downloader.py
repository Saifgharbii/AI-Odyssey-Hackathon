    ...
    snapshot_download(repo_id="XLabs-AI/flux-dev-fp8", local_dir="AI Models/Text2Image/flux-dev-fp8")
    snapshot_download(repo_id="NimVideo/cogvideox-2b-img2vid", local_dir="AI Models/Text-Image2Video/cogvideox-2b-img2vid")
